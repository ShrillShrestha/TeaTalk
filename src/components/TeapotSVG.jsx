export default function TeapotSVG({ w = 80, h = 48 }) {
  return (
    <svg viewBox="0 0 80 48" width={w} height={h} style={{ display: 'block', overflow: 'visible' }}>
      <path d="M16 18 q-9 0 -9 9 q0 9 9 9" stroke="#b85b3e" strokeWidth="3.6" fill="none" strokeLinecap="round" />
      <ellipse cx="30" cy="28" rx="15" ry="12" fill="#c8694a" />
      <polygon points="43,20 58,11 47,28" fill="#c8694a" />
      <ellipse cx="30" cy="16" rx="9" ry="3" fill="#b85b3e" />
      <circle cx="30" cy="11.6" r="2.4" fill="#b85b3e" />
